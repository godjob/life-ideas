...
[SKILL.md仕様：ファイル命名ルールとフォルダ構造](skill-md-specification.md)で定義されたSKILL.md仕様に従って、手動で作成したスキル定義をskill-creatorに提示すると、以下を自動検証します：
...
[Skillテスト戦略：トリガー・機能・パフォーマンス検証の3段階](skill-testing-strategy.md)の3段階テストを通じて収集したデータをskill-creatorに入力すると：
...
改善提案の出力
    ↓
[速さが命題：検討より先にプロトタイプを出す姿勢](speed-first-prototyping.md)フローへの統合
    ↓
実装チームへのフィードバック
```
...
1. **Skillの初期作成**：[SKILL.md仕様：ファイル命名ルールとフォルダ構造](skill-md-specification.md)に従ってSKILL.mdを作成
...
- [SKILL.md仕様：ファイル命名ルールとフォルダ構造](skill-md-specification.md) - SKILL.md仕様書
...
- [速さが命題：検討より先にプロトタイプを出す姿勢](speed-first-prototyping.md) - 高速プロトタイピング手法
